...
// FIX: debounce sur la recherche pour éviter trop de requêtes
...
export default function ToolsPage() {
  ...
  // Recharge les outils quand keyword, category ou page change
  ...
  useEffect(() => {
    // Reset page à 1 si on change les filtres
    setPage(1);
  }, [keyword, category]);
